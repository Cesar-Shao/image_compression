...
class KJPEG:
    ...
    def __Encode(self, matrix, tag):
        ...
        print('unQ start')
        f=open('/Users/cesar/Desktop/同步储存/net/jpeg/code_v1/losQ_dct_res.txt','w')
        for i in res:
            f.write(str(i))
            f.write('\n'+'-------------------'+'\n')
        f.close()
        ...
        '''
        print('Q start')
        f=open('/Users/cesar/Desktop/同步储存/net/jpeg&so on/code_v1/Q_dct_res.txt','w')
        for i in res:
            f.write(str(i))
            f.write('\n'+'-------------------'+'\n')
        f.close()
...
if __name__ == '__main__':
    kjpeg = KJPEG()
    kjpeg.Compress("./test.bmp")
    kjpeg.Decompress("./test_comp")
